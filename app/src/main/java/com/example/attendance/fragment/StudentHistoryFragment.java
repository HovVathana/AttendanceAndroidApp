...
import com.example.attendance.adapter.StudentAttendanceAdapter;
...
public class StudentHistoryFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        SharedPreferences settings = getContext().getSharedPreferences(CONSTANT.LOGIN_PREF, 0);
        String studentId = settings.getString("id", "");

        recyclerView = view.findViewById(R.id.studentAttendanceView);
